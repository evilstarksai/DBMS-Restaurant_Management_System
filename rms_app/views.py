...
class FoodImgViewStarter(ListView):
    model = Food
    template_name = "rms_app/food_starters.html"  
    context_object_name = "food_obj"

class FoodImgViewMainCourse(ListView):
    model = Food
    template_name = "rms_app/food_maincourse.html"  
    context_object_name = "food_obj"

class FoodImgViewDesserts(ListView):
    model = Food
    template_name = "rms_app/food_desserts.html"  
    context_object_name = "food_obj"

class FoodImgViewBeverages(ListView):
    model = Food
    template_name = "rms_app/food_beverages.html"  
    context_object_name = "food_obj"
