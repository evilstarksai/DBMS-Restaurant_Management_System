...
from .views import ( 
    ...
    FoodImgView,
    FoodImgViewStarter,
    FoodImgViewMainCourse,
    FoodImgViewDesserts,
    FoodImgViewBeverages,
    CreateInvoiceView,
    DeleteInvoiceView,
    SalesView,
...
urlpatterns = [
    ...
    path("food/all", FoodImgView.as_view(), name="rms-food"),
    path("food/starters", FoodImgViewStarter.as_view(), name="rms-food_starters"),
    path("food/maincourse", FoodImgViewMainCourse.as_view(), name="rms-food_maincourse"),
    path("food/desserts", FoodImgViewDesserts.as_view(), name="rms-food_desserts"),
    path("food/beverages", FoodImgViewBeverages.as_view(), name="rms-food_beverages"),
